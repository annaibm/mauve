...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedMethods_jdk6.put("public java.lang.String java.util.IllegalFormatCodePointException.getMessage()", "getMessage");
        testedMethods_jdk6.put("public int java.util.IllegalFormatCodePointException.getCodePoint()", "getCodePoint");
        ...
        testedMethods_jdk7.put("public java.lang.String java.util.IllegalFormatCodePointException.getMessage()", "getMessage");
        testedMethods_jdk7.put("public int java.util.IllegalFormatCodePointException.getCodePoint()", "getCodePoint");
