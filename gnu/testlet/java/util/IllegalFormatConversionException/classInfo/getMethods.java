...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedMethods_jdk6.put("public java.lang.String java.util.IllegalFormatConversionException.getMessage()", "getMessage");
        testedMethods_jdk6.put("public char java.util.IllegalFormatConversionException.getConversion()", "getConversion");
        testedMethods_jdk6.put("public java.lang.Class java.util.IllegalFormatConversionException.getArgumentClass()", "getArgumentClass");
        ...
        testedMethods_jdk7.put("public java.lang.String java.util.IllegalFormatConversionException.getMessage()", "getMessage");
        testedMethods_jdk7.put("public char java.util.IllegalFormatConversionException.getConversion()", "getConversion");
        testedMethods_jdk7.put("public java.lang.Class java.util.IllegalFormatConversionException.getArgumentClass()", "getArgumentClass");
