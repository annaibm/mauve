...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        harness.check(((RectangularShape)e).getX(), 0.0);
        harness.check(((RectangularShape)e).getY(), 0.0);
        harness.check(((RectangularShape)e).getWidth(), 0.0);
        harness.check(((RectangularShape)e).getHeight(), 0.0);
        harness.check(((RectangularShape)e).isEmpty());
        e = new Ellipse2D.Double(1.0, 2.0, 3.0, 4.0);
        harness.check(((RectangularShape)e).getX(), 1.0);
        harness.check(((RectangularShape)e).getY(), 2.0);
