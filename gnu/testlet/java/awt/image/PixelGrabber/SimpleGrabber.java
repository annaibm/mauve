 G: 31 B: 76\nPixel (0, 7)\n   R: 137 G: 79 B: 127\nPixel (1, 7)\n   R: 123 G: 65 B: 113\nPixel (2, 7)\n   R: 65 G: 7 B: 55\nPixel (3, 7)\n   R: 78 G: 20 B: 68\nPixel (4, 7)\n   R: 149 G: 92 B: 137\nPixel (5, 7)\n   R: 95 G: 38 B: 83\nPixel (0, 8)\n   R: 138 G: 80 B: 128\nPixel (1, 8)\n   R: 96 G: 38 B: 86\nPixel (2, 8)\n   R: 78 G: 20 B: 68\nPixel (3, 8)\n   R: 76 G: 18 B: 66\nPixel (4, 8)\n   R: 106 G: 49 B: 94\nPixel (5, 8)\n   R: 122 G: 65 B: 110\nPixel (0, 9)\n   R: 155 G: 97 B: 145\nPixel (1, 9)\n   R: 99 G: 41 B: 89\nPixel (2, 9)\n   R: 73 G: 15 B: 63\nPixel (3, 9)\n   R: 80 G: 22 B: 70\nPixel (4, 9)\n   R: 115 G: 58 B: 103\nPixel (5, 9)\n   R: 107 G: 50 B: 95\nPixel (0, 10)\n   R: 165 G: 106 B: 154\nPixel (1, 10)\n   R: 99 G: 40 B: 88\nPixel (2, 10)\n   R: 68 G: 9 B: 57\nPixel (3, 10)\n   R: 83 G: 24 B: 72\nPixel (4, 10)\n   R: 123 G: 64 B: 110\nPixel (5, 10)\n   R: 88 G: 29 B: 75\nPixel (0, 11)\n   R: 151 G: 92 B: 140\nPixel (1, 11)\n   R: 93 G: 34 B: 82\nPixel (2, 11)\n   R: 68 G: 9 B: 57\nPixel (3, 11)\n   R: 81 G: 22 B: 70\nPixel (4, 11)\n   R: 120 G: 58 B: 105\nPixel (5, 11)\n   R: 74 G: 12 B: 59\n");
    }
    ...
    public String getPixels(Image img, int x, int y, int w, int h) {
        ...
        try {
            ...
            this.harness.fail("image production interrupted.");
            return "";
        }
        if ((pg.getStatus() & 0x80) != 0) {
            this.harness.fail("image production aborted.");
            return "";
        }
        String result = "";
        for (int j = 0; j < h; ++j) {
            for (int i = 0; i < w; ++i) {
                int p = j * w + i;
                result = result + this.getPixel(x + i, y + j, pix[p]);
            }
        }
        return result;
    }
    ...
    public String getPixel(int x, int y, int pixel) {
        ColorModel model2 = ColorModel.getRGBdefault();
        return "Pixel (" + x + ", " + y + ")\n   R: " + model2.getRed(pixel) + " G: " + model2.getGreen(pixel) + " B: " + model2.getBlue(pixel) + "\n";
    }
}
