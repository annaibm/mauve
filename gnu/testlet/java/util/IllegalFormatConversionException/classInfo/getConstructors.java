...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedConstructors_jdk6.put("public java.util.IllegalFormatConversionException(char,java.lang.Class)", "java.util.IllegalFormatConversionException");
        testedConstructors_jdk7.put("public java.util.IllegalFormatConversionException(char,java.lang.Class)", "java.util.IllegalFormatConversionException");
