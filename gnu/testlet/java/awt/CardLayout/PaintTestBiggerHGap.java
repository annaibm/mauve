...
implements Testlet {
    ...
    private void doTest(TestHarness harness, Robot robot, Frame frame, Component component2, Color componentColor) {
        ...
        harness.check(this.getColorForLeftBorder(robot, frame, component2), BACKGROUND_COLOR);
        harness.check(this.getColorForRightBorder(robot, frame, component2), BACKGROUND_COLOR);
