...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        String[] fieldsThatShouldExist_jdk6 = new String[]{"MIN_VALUE", "MAX_VALUE", "TYPE", "value", "SIZE", "serialVersionUID"};
        String[] fieldsThatShouldExist_jdk7 = new String[]{"MIN_VALUE", "MAX_VALUE", "TYPE", "value", "SIZE", "serialVersionUID"};
