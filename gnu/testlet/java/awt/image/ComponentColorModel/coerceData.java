...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        this.runTest(harness, new BandedSampleModel(0, 50, 50, 4));
        harness.checkPoint("coerceData with ComponentSampleModel");
        this.runTest(harness, new ComponentSampleModel(0, 50, 50, 4, 200, new int[]{0, 1, 2, 3}));
        harness.checkPoint("coerceData with PixelInterleavedSampleModel");
        this.runTest(harness, new PixelInterleavedSampleModel(0, 50, 50, 4, 200, new int[]{0, 1, 2, 3}));
    }
    ...
    private void runTest(TestHarness harness, SampleModel sample) {
        ...
        ComponentColorModel ccm = new ComponentColorModel(ColorSpace.getInstance(1000), true, false, 2, 0);
