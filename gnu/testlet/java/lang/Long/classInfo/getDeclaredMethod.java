...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        methodsThatShouldExist_jdk6.put("stringSize", new Class[]{Long.TYPE});
        ...
        methodsThatShouldExist_jdk6.put("toUnsignedString", new Class[]{Long.TYPE, Integer.TYPE});
        ...
        methodsThatShouldExist_jdk7.put("stringSize", new Class[]{Long.TYPE});
        ...
        methodsThatShouldExist_jdk7.put("toUnsignedString", new Class[]{Long.TYPE, Integer.TYPE});
