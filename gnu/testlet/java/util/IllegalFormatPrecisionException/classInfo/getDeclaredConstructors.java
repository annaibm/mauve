...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedDeclaredConstructors_jdk6.put("public java.util.IllegalFormatPrecisionException(int)", "java.util.IllegalFormatPrecisionException");
        testedDeclaredConstructors_jdk7.put("public java.util.IllegalFormatPrecisionException(int)", "java.util.IllegalFormatPrecisionException");
