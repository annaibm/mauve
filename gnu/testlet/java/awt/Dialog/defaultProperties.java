...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        harness.check(dialog.getLayout().toString(), (Object)"java.awt.BorderLayout[hgap=0,vgap=0]");
        harness.check(dialog.getLocation(), new Point());
        harness.check(dialog.getMaximumSize(), new Dimension(Integer.MAX_VALUE, Integer.MAX_VALUE));
        harness.check(dialog.getMinimumSize(), new Dimension());
        harness.check(dialog.getName(), (Object)"dialog0");
