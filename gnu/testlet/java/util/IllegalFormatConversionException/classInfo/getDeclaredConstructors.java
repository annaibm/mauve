...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedDeclaredConstructors_jdk6.put("public java.util.IllegalFormatConversionException(char,java.lang.Class)", "java.util.IllegalFormatConversionException");
        testedDeclaredConstructors_jdk7.put("public java.util.IllegalFormatConversionException(char,java.lang.Class)", "java.util.IllegalFormatConversionException");
