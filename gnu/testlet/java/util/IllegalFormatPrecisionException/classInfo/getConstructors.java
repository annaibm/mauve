...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedConstructors_jdk6.put("public java.util.IllegalFormatPrecisionException(int)", "java.util.IllegalFormatPrecisionException");
        testedConstructors_jdk7.put("public java.util.IllegalFormatPrecisionException(int)", "java.util.IllegalFormatPrecisionException");
