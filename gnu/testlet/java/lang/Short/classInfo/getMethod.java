...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        methodsThatShouldExist_jdk6.put("toString", new Class[]{Short.TYPE});
        methodsThatShouldExist_jdk6.put("hashCode", new Class[0]);
        methodsThatShouldExist_jdk6.put("reverseBytes", new Class[]{Short.TYPE});
        methodsThatShouldExist_jdk6.put("compareTo", new Class[]{Object.class});
        methodsThatShouldExist_jdk6.put("compareTo", new Class[]{Short.class});
        ...
        methodsThatShouldExist_jdk6.put("valueOf", new Class[]{Short.TYPE});
        ...
        methodsThatShouldExist_jdk6.put("parseShort", new Class[]{String.class, Integer.TYPE});
        methodsThatShouldExist_jdk6.put("parseShort", new Class[]{String.class});
        ...
        methodsThatShouldExist_jdk7.put("toString", new Class[]{Short.TYPE});
        methodsThatShouldExist_jdk7.put("hashCode", new Class[0]);
        methodsThatShouldExist_jdk7.put("reverseBytes", new Class[]{Short.TYPE});
        methodsThatShouldExist_jdk7.put("compareTo", new Class[]{Object.class});
        methodsThatShouldExist_jdk7.put("compareTo", new Class[]{Short.class});
        ...
        methodsThatShouldExist_jdk7.put("valueOf", new Class[]{Short.TYPE});
        methodsThatShouldExist_jdk7.put("compare", new Class[]{Short.TYPE, Short.TYPE});
        methodsThatShouldExist_jdk7.put("decode", new Class[]{String.class});
        methodsThatShouldExist_jdk7.put("parseShort", new Class[]{String.class, Integer.TYPE});
        methodsThatShouldExist_jdk7.put("parseShort", new Class[]{String.class});
