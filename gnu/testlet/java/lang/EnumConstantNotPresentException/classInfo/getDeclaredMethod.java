...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        methodsThatShouldExist_jdk6.put("enumType", new Class[0]);
        methodsThatShouldExist_jdk6.put("constantName", new Class[0]);
        HashMap<String, Class[]> methodsThatShouldExist_jdk7 = new HashMap<String, Class[]>();
        methodsThatShouldExist_jdk7.put("constantName", new Class[0]);
        methodsThatShouldExist_jdk7.put("enumType", new Class[0]);
