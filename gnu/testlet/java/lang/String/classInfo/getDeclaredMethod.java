...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        methodsThatShouldExist_jdk6.put("indexOf", new Class[]{new char[1].getClass(), Integer.TYPE, Integer.TYPE, new char[1].getClass(), Integer.TYPE, Integer.TYPE, Integer.TYPE});
        ...
        methodsThatShouldExist_jdk6.put("checkBounds", new Class[]{new byte[1].getClass(), Integer.TYPE, Integer.TYPE});
        ...
        methodsThatShouldExist_jdk6.put("getChars", new Class[]{new char[1].getClass(), Integer.TYPE});
        ...
        methodsThatShouldExist_jdk6.put("lastIndexOf", new Class[]{new char[1].getClass(), Integer.TYPE, Integer.TYPE, new char[1].getClass(), Integer.TYPE, Integer.TYPE, Integer.TYPE});
        ...
        methodsThatShouldExist_jdk7.put("indexOf", new Class[]{new char[1].getClass(), Integer.TYPE, Integer.TYPE, new char[1].getClass(), Integer.TYPE, Integer.TYPE, Integer.TYPE});
        ...
        methodsThatShouldExist_jdk7.put("checkBounds", new Class[]{new byte[1].getClass(), Integer.TYPE, Integer.TYPE});
        ...
        methodsThatShouldExist_jdk7.put("getChars", new Class[]{new char[1].getClass(), Integer.TYPE});
        methodsThatShouldExist_jdk7.put("getChars", new Class[]{Integer.TYPE, Integer.TYPE, new char[1].getClass(), Integer.TYPE});
        methodsThatShouldExist_jdk7.put("hash32", new Class[0]);
        methodsThatShouldExist_jdk7.put("indexOfSupplementary", new Class[]{Integer.TYPE, Integer.TYPE});
        ...
        methodsThatShouldExist_jdk7.put("lastIndexOf", new Class[]{new char[1].getClass(), Integer.TYPE, Integer.TYPE, new char[1].getClass(), Integer.TYPE, Integer.TYPE, Integer.TYPE});
        methodsThatShouldExist_jdk7.put("lastIndexOfSupplementary", new Class[]{Integer.TYPE, Integer.TYPE});
