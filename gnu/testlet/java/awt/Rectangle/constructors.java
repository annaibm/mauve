...
implements Testlet {
    ...
    public void testConstructor1(TestHarness harness) {
        ...
        harness.check(r.getWidth(), 0.0);
        harness.check(r.getHeight(), 0.0);
    }
    ...
    public void testConstructor2(TestHarness harness) {
        ...
        harness.check(r4.getX(), 1.0);
        harness.check(r4.getY(), 2.0);
        harness.check(r4.getWidth(), 3.0);
        harness.check(r4.getHeight(), 4.0);
        boolean failed = false;
        Rectangle r5 = null;
        try {
            Rectangle rectangle = new Rectangle(r5);
        }
    ...
    public void testConstructor3(TestHarness harness) {
        ...
        harness.check(r1.getY(), 10.0);
        harness.check(r1.getWidth(), 15.0);
        harness.check(r1.getHeight(), 20.0);
        Rectangle r2 = new Rectangle(-5, -10, -15, -20);
        harness.check(r2.getX(), -5.0);
        harness.check(r2.getY(), -10.0);
        harness.check(r2.getWidth(), -15.0);
        harness.check(r2.getHeight(), -20.0);
    }
    ...
    public void testConstructor4(TestHarness harness) {
        ...
        harness.check(r1.getWidth(), 5.0);
        harness.check(r1.getHeight(), 10.0);
        Rectangle r2 = new Rectangle(-5, -10);
        harness.check(r2.getX(), 0.0);
        harness.check(r2.getY(), 0.0);
        harness.check(r2.getWidth(), -5.0);
        harness.check(r2.getHeight(), -10.0);
    }
    ...
    public void testConstructor5(TestHarness harness) {
        ...
        try {
            Rectangle rectangle = new Rectangle(p3, d3);
        }
        catch (NullPointerException e) {
            failed1 = true;
        }
    ...
    public void testConstructor6(TestHarness harness) {
        ...
        Point p3 = null;
        try {
            Rectangle rectangle = new Rectangle(p3);
        }
        catch (NullPointerException e) {
            failed = true;
        }
        ...
        harness.check(r4.getX(), -5.0);
        harness.check(r4.getY(), -10.0);
        harness.check(r4.getWidth(), 0.0);
        harness.check(r4.getHeight(), 0.0);
    }
    ...
    public void testConstructor7(TestHarness harness) {
        ...
        Dimension d3 = null;
        try {
            Rectangle rectangle = new Rectangle(d3);
        }
        catch (NullPointerException e) {
            failed = true;
        }
        ...
        harness.check(r4.getX(), 0.0);
        harness.check(r4.getY(), 0.0);
        harness.check(r4.getWidth(), -15.0);
        harness.check(r4.getHeight(), -20.0);
    }
}
