...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        String[] fieldsThatShouldExist_jdk6 = new String[]{"POSITIVE_INFINITY", "NEGATIVE_INFINITY", "NaN", "MAX_VALUE", "MIN_NORMAL", "MIN_VALUE", "MAX_EXPONENT", "MIN_EXPONENT", "SIZE", "TYPE", "value", "serialVersionUID"};
        String[] fieldsThatShouldExist_jdk7 = new String[]{"POSITIVE_INFINITY", "NEGATIVE_INFINITY", "NaN", "MAX_VALUE", "MIN_NORMAL", "MIN_VALUE", "MAX_EXPONENT", "MIN_EXPONENT", "SIZE", "TYPE", "value", "serialVersionUID"};
