...
public class getLineSpacing
implements Testlet {
    @Override
    public void test(TestHarness harness) {
        SimpleAttributeSet s = new SimpleAttributeSet();
        harness.check(StyleConstants.getLineSpacing(s), 0.0);
        StyleConstants.setLineSpacing(s, 1.0f);
        harness.check(StyleConstants.getLineSpacing(s), 1.0);
        ...
        harness.check(StyleConstants.getLineSpacing(s), 2.0);
        boolean pass = false;
        try {
