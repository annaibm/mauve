...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        String[] fieldsThatShouldExist_jdk6 = new String[]{"pkgs", "urls", "mans", "pkgName", "specTitle", "specVersion", "specVendor", "implTitle", "implVersion", "implVendor", "sealBase", "loader", "packageInfo"};
        String[] fieldsThatShouldExist_jdk7 = new String[]{"pkgs", "urls", "mans", "pkgName", "specTitle", "specVersion", "specVendor", "implTitle", "implVersion", "implVendor", "sealBase", "loader", "packageInfo"};
