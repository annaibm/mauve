...
import gnu.testlet.javax.swing.plaf.metal.MetalLookAndFeel.MyMetalLookAndFeel;
...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        harness.check(defaults.get("Button.font"), new FontUIResource("Dialog", 0, 13));
        ...
        harness.check(defaults.get("CheckBox.font"), new FontUIResource("Dialog", 0, 13));
        ...
        harness.check(defaults.get("CheckBoxMenuItem.acceleratorFont"), new Font("Dialog", 0, 10));
        ...
        harness.check(defaults.get("CheckBoxMenuItem.commandSound"), (Object)"sounds/MenuItemCommand.wav");
        harness.check(defaults.get("CheckBoxMenuItem.disabledForeground"), new ColorUIResource(0, 0, 16));
        harness.check(defaults.get("CheckBoxMenuItem.font"), new FontUIResource("Dialog", 0, 15));
        ...
        harness.check(defaults.get("ComboBox.font"), new FontUIResource("Dialog", 0, 13));
        ...
        harness.check(defaults.get("DesktopIcon.font"), new FontUIResource("Dialog", 0, 13));
        ...
        harness.check(defaults.get("EditorPane.font"), new FontUIResource("Dialog", 0, 12));
        ...
        harness.check(defaults.get("FormattedTextField.font"), new FontUIResource("Dialog", 0, 12));
        ...
        harness.check(defaults.get("InternalFrame.closeSound"), (Object)"sounds/FrameClose.wav");
        ...
        harness.check(defaults.get("InternalFrame.maximizeSound"), (Object)"sounds/FrameMaximize.wav");
        harness.check(defaults.get("InternalFrame.minimizeIcon") instanceof Icon);
        harness.check(defaults.get("InternalFrame.minimizeSound"), (Object)"sounds/FrameMinimize.wav");
        ...
        harness.check(defaults.get("InternalFrame.restoreDownSound"), (Object)"sounds/FrameRestoreDown.wav");
        harness.check(defaults.get("InternalFrame.restoreUpSound"), (Object)"sounds/FrameRestoreUp.wav");
        ...
        harness.check(defaults.get("Label.font"), new FontUIResource("Dialog", 0, 13));
        ...
        harness.check(defaults.get("List.font"), new FontUIResource("Dialog", 0, 13));
        ...
        harness.check(defaults.get("Menu.acceleratorFont"), new FontUIResource("Dialog", 0, 10));
        ...
        harness.check(defaults.get("Menu.font"), new FontUIResource("Dialog", 0, 15));
        ...
        int[] value2 = (int[])defaults.get("Menu.shortcutKeys");
        harness.check(value2 != null ? value2.length : 0, 1);
        harness.check(value2 != null ? value2[0] : 0, 8);
        ...
        harness.check(defaults.get("MenuBar.font"), new FontUIResource("Dialog", 0, 15));
        ...
        harness.check(bindings[0], (Object)"F10");
        harness.check(bindings[1], (Object)"takeFocus");
        harness.checkPoint("MenuItem");
        harness.check(defaults.get("MenuItem.acceleratorDelimiter"), (Object)"-");
        harness.check(defaults.get("MenuItem.acceleratorFont"), new FontUIResource("Dialog", 0, 10));
        ...
        harness.check(defaults.get("MenuItem.commandSound"), (Object)"sounds/MenuItemCommand.wav");
        harness.check(defaults.get("MenuItem.disabledForeground"), new ColorUIResource(0, 0, 16));
        harness.check(defaults.get("MenuItem.font"), new FontUIResource("Dialog", 0, 15));
        ...
        harness.check(defaults.get("OptionPane.errorSound"), (Object)"sounds/OptionPaneError.wav");
        ...
        harness.check(defaults.get("OptionPane.informationSound"), (Object)"sounds/OptionPaneInformation.wav");
        ...
        harness.check(defaults.get("OptionPane.questionSound"), (Object)"sounds/OptionPaneQuestion.wav");
        ...
        harness.check(defaults.get("OptionPane.warningSound"), (Object)"sounds/OptionPaneWarning.wav");
        bindings = (Object[])defaults.get("OptionPane.windowBindings");
        harness.check(bindings.length, 2);
        harness.check(bindings[0], (Object)"ESCAPE");
        harness.check(bindings[1], (Object)"close");
        ...
        harness.check(defaults.get("PasswordField.font"), new FontUIResource("Dialog", 0, 12));
        ...
        harness.check(defaults.get("PopupMenu.font"), new FontUIResource("Dialog", 0, 15));
        harness.check(defaults.get("PopupMenu.foreground"), new ColorUIResource(0, 0, 17));
        harness.check(defaults.get("PopupMenu.popupSound"), (Object)"sounds/PopupMenuPopup.wav");
        ...
        BorderUIResource.LineBorderUIResource b = (BorderUIResource.LineBorderUIResource)defaults.get("ProgressBar.border");
        ...
        harness.check(defaults.get("ProgressBar.font"), new FontUIResource("Dialog", 0, 13));
        ...
        harness.check(defaults.get("RadioButton.font"), new FontUIResource("Dialog", 0, 13));
        ...
        harness.check(defaults.get("RadioButtonMenuItem.acceleratorFont"), new Font("Dialog", 0, 10));
        ...
        harness.check(defaults.get("RadioButtonMenuItem.commandSound"), (Object)"sounds/MenuItemCommand.wav");
        harness.check(defaults.get("RadioButtonMenuItem.disabledForeground"), new ColorUIResource(0, 0, 16));
        harness.check(defaults.get("RadioButtonMenuItem.font"), new FontUIResource("Dialog", 0, 15));
        ...
        KeyStroke[] keys2 = focusInputMap.keys();
        ...
        harness.check(focusInputMap.get(KeyStroke.getKeyStroke("ctrl PAGE_DOWN")), (Object)"negativeBlockIncrement");
        harness.check(focusInputMap.get(KeyStroke.getKeyStroke("ctrl PAGE_UP")), (Object)"positiveBlockIncrement");
        ...
        harness.check(defaults.get("Spinner.font"), new FontUIResource("Dialog", 0, 13));
        ...
        harness.check(defaults.get("TabbedPane.font"), new FontUIResource("Dialog", 0, 13));
        ...
        harness.check(defaults.get("TextArea.font"), new FontUIResource("Dialog", 0, 12));
        ...
        harness.check(defaults.get("TextField.font"), new FontUIResource("Dialog", 0, 12));
        ...
        harness.check(defaults.get("TextPane.font"), new FontUIResource("Dialog", 0, 12));
        ...
        harness.check(defaults.get("TitledBorder.border") instanceof BorderUIResource.LineBorderUIResource);
        harness.check(defaults.get("TitledBorder.font"), new FontUIResource("Dialog", 0, 13));
        ...
        harness.check(defaults.get("ToggleButton.font"), new FontUIResource("Dialog", 0, 13));
        ...
        harness.check(defaults.get("ToolBar.font"), new FontUIResource("Dialog", 0, 15));
        ...
        BorderUIResource.LineBorderUIResource b2 = (BorderUIResource.LineBorderUIResource)defaults.get("ToolTip.border");
        harness.check(b2.getThickness(), 1);
        harness.check(b2.getLineColor(), new Color(0, 0, 21));
        b2 = (BorderUIResource.LineBorderUIResource)defaults.get("ToolTip.borderInactive");
        harness.check(b2 != null ? b2.getThickness() : 0, 1);
        harness.check(b2 != null ? b2.getLineColor() : null, new Color(0, 0, 5));
        harness.check(defaults.get("ToolTip.font"), new FontUIResource("Dialog", 0, 12));
    ...
    extends DefaultMetalTheme {
        ...
        public FontUIResource getMenuTextFont() {
            return new FontUIResource("Dialog", 0, 15);
        }
    }
}
