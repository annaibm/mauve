...
implements Testlet {
    ...
    public void test(TestHarness h) {
        ...
        DataBufferUShort buf = new DataBufferUShort(new short[][]{data, data}, 2, new int[]{2, 0});
        h.check(((DataBuffer)buf).getElem(0), 65503);
        h.check(((DataBuffer)buf).getElem(1), 65492);
        h.check(((DataBuffer)buf).getElem(0, 0), 65503);
        h.check(((DataBuffer)buf).getElem(0, 1), 65492);
        h.check(((DataBuffer)buf).getElem(1, 0), 65525);
        h.check(((DataBuffer)buf).getElem(1, 1), 65514);
        this.testGetElem1(h);
        this.testGetElem2(h);
    }
