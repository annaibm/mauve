...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        constructorsThatShouldExist_jdk6.put("java.lang.CloneNotSupportedException", new Class[0]);
        constructorsThatShouldExist_jdk6.put("java.lang.CloneNotSupportedException", new Class[]{String.class});
        HashMap<String, Class[]> constructorsThatShouldExist_jdk7 = new HashMap<String, Class[]>();
        constructorsThatShouldExist_jdk7.put("java.lang.CloneNotSupportedException", new Class[0]);
        constructorsThatShouldExist_jdk7.put("java.lang.CloneNotSupportedException", new Class[]{String.class});
