...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedDeclaredMethods_jdk6.put("public java.lang.String java.util.IllegalFormatCodePointException.getMessage()", "getMessage");
        testedDeclaredMethods_jdk6.put("public int java.util.IllegalFormatCodePointException.getCodePoint()", "getCodePoint");
        testedDeclaredMethods_jdk7.put("public java.lang.String java.util.IllegalFormatCodePointException.getMessage()", "getMessage");
        testedDeclaredMethods_jdk7.put("public int java.util.IllegalFormatCodePointException.getCodePoint()", "getCodePoint");
