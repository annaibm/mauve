...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedMethods_jdk6.put("public java.lang.String java.util.IllegalFormatPrecisionException.getMessage()", "getMessage");
        testedMethods_jdk6.put("public int java.util.IllegalFormatPrecisionException.getPrecision()", "getPrecision");
        ...
        testedMethods_jdk7.put("public java.lang.String java.util.IllegalFormatPrecisionException.getMessage()", "getMessage");
        testedMethods_jdk7.put("public int java.util.IllegalFormatPrecisionException.getPrecision()", "getPrecision");
