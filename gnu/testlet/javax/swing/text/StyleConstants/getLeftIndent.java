...
public class getLeftIndent
implements Testlet {
    @Override
    public void test(TestHarness harness) {
        SimpleAttributeSet s = new SimpleAttributeSet();
        harness.check(StyleConstants.getLeftIndent(s), 0.0);
        StyleConstants.setLeftIndent(s, 1.0f);
        harness.check(StyleConstants.getLeftIndent(s), 1.0);
        ...
        harness.check(StyleConstants.getLeftIndent(s), 2.0);
        boolean pass = false;
        try {
