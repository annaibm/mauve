...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        constructorsThatShouldExist_jdk6.put("java.lang.ExceptionInInitializerError", new Class[0]);
        constructorsThatShouldExist_jdk6.put("java.lang.ExceptionInInitializerError", new Class[]{Throwable.class});
        constructorsThatShouldExist_jdk6.put("java.lang.ExceptionInInitializerError", new Class[]{String.class});
        HashMap<String, Class[]> constructorsThatShouldExist_jdk7 = new HashMap<String, Class[]>();
        constructorsThatShouldExist_jdk7.put("java.lang.ExceptionInInitializerError", new Class[]{String.class});
        constructorsThatShouldExist_jdk7.put("java.lang.ExceptionInInitializerError", new Class[]{Throwable.class});
        constructorsThatShouldExist_jdk7.put("java.lang.ExceptionInInitializerError", new Class[0]);
