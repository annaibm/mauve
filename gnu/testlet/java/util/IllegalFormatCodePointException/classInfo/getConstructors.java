...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedConstructors_jdk6.put("public java.util.IllegalFormatCodePointException(int)", "java.util.IllegalFormatCodePointException");
        testedConstructors_jdk7.put("public java.util.IllegalFormatCodePointException(int)", "java.util.IllegalFormatCodePointException");
