...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        constructorsThatShouldExist_jdk6.put("java.lang.Float", new Class[]{String.class});
        constructorsThatShouldExist_jdk6.put("java.lang.Float", new Class[]{Double.TYPE});
        constructorsThatShouldExist_jdk6.put("java.lang.Float", new Class[]{Float.TYPE});
        HashMap<String, Class[]> constructorsThatShouldExist_jdk7 = new HashMap<String, Class[]>();
        constructorsThatShouldExist_jdk7.put("java.lang.Float", new Class[]{String.class});
        constructorsThatShouldExist_jdk7.put("java.lang.Float", new Class[]{Double.TYPE});
        constructorsThatShouldExist_jdk7.put("java.lang.Float", new Class[]{Float.TYPE});
