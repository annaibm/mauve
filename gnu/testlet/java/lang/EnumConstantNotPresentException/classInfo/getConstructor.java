...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        constructorsThatShouldExist_jdk6.put("java.lang.EnumConstantNotPresentException", new Class[]{Class.class, String.class});
        HashMap<String, Class[]> constructorsThatShouldExist_jdk7 = new HashMap<String, Class[]>();
        constructorsThatShouldExist_jdk7.put("java.lang.EnumConstantNotPresentException", new Class[]{Class.class, String.class});
