...
public class getSpaceAbove
implements Testlet {
    @Override
    public void test(TestHarness harness) {
        SimpleAttributeSet s = new SimpleAttributeSet();
        harness.check(StyleConstants.getSpaceAbove(s), 0.0);
        StyleConstants.setSpaceAbove(s, 1.0f);
        harness.check(StyleConstants.getSpaceAbove(s), 1.0);
        ...
        harness.check(StyleConstants.getSpaceAbove(s), 2.0);
        boolean pass = false;
        try {
