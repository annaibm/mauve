...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        table2.getColumnModel().getColumn(1).setCellRenderer(new MyBooleanTableCellRenderer());
        ...
        harness.check(accessibleCell1.getAccessibleContext().getAccessibleRole(), AccessibleRole.CHECK_BOX);
        Accessible accessibleCell2 = at.getAccessibleAt(0, 2);
        harness.check(accessibleCell2.getAccessibleContext().getAccessibleRole(), AccessibleRole.LABEL);
    }
}
