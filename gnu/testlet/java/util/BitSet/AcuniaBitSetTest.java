...
implements Testlet {
    ...
    public void test_clone() {
        ...
        bsc = (BitSet)bs.clone();
        bs.set(4);
        this.th.check(!bsc.get(4), "changes in the original don't affect the clone");
    }
    ...
    public void test_equals() {
        ...
        this.th.check(!bs.equals(null), "returns false if compared to null");
        this.th.check(!bs.equals("dsf"), "returns false if compared to another Object");
        Vector<Integer> v = new Vector<Integer>();
        for (i = 0; i < 64; i += 2) {
            v.add(new Integer(1));
            v.add(new Integer(0));
        }
        this.th.check(!bs.equals(v), "returns false if compared to a vector");
        BitSet bsc = (BitSet)bs.clone();
        this.th.check(bsc.equals(bs), "a BitSet equals his clone");
        bs.set(1);
        this.th.check(!bsc.equals(bs), "one different bit ==> not equal");
        bs.clear(1);
        bsc.clear(100);
        ...
        bsc.set(127);
        this.th.check(!bsc.equals(bs), "different size don't have to be equal -- 1");
        this.th.check(!bs.equals(bsc), "different size don't have to be equal -- 2");
    }

    public void test_hashCode() {
        this.th.checkPoint("hashCode()int");
        BitSet bs = new BitSet(34);
        this.th.check(bs.hashCode() == 1234, "checking hashCode for empty BitSet size 64");
        bs = new BitSet(0);
        this.th.check(bs.hashCode() == 1234, "checking hashCode for empty BitSet size 0");
        for (int i = 0; i < 8; ++i) {
            bs.set(i);
        }
        this.th.check(bs.hashCode() == 1069, "checking hashCode for  BitSet  FF");
    }

    public void test_toString() {
        this.th.checkPoint("toString()java.lang.String");
        BitSet bs = new BitSet();
        this.th.check("{}".equals(bs.toString()), "check empty BitSet");
        bs.set(1);
        this.th.check("{1}".equals(bs.toString()), "check BitSet string representation -- 1");
        bs.set(60);
        this.th.check("{1, 60}".equals(bs.toString()), "check BitSet string representation -- 1");
        bs.set(15);
        this.th.check("{1, 15, 60}".equals(bs.toString()), "check BitSet string representation -- 1");
    }
    ...
    public void test_and() {
        ...
        bs2.set(1);
        bs1.and(bs2);
        this.th.check(bs1.get(1) && bs2.equals(bs1), "checking and -- 1");
        for (i = 0; i < 64; ++i) {
            bs2.set(i);
            bs1.set(i);
        }
    ...
    public void test_andNot() {
        ...
        bs3.andNot(bs2);
        this.th.check(!bs3.get(1) && bs3.equals(bs1), "checking andNot -- 1");
        for (i = 0; i < 64; ++i) {
            bs2.set(i);
            bs1.set(i);
        }
        ...
        bs2.clear(0);
        bs2.andNot(bs1);
        this.th.check(!bs2.get(0), "checking or -- 1");
        bs2.set(0);
        bs2.andNot(bs1);
    ...
    public void test_clear() {
        ...
        bs.clear(4);
        this.th.check(!bs.get(4), "make sure the clear worked -- 1");
        bs.clear(4);
        this.th.check(!bs.get(4), "make sure the clear worked -- 2");
        bs.clear(123);
        try {
            bs.clear(-1);
    ...
    public void test_get() {
        ...
        this.th.check(!bs.get(Integer.MAX_VALUE), "returns false if pos > size");
        bs.set(3);
        this.th.check(bs.get(3), "returns true if pos is set");
        bs.clear(3);
        this.th.check(!bs.get(3), "returns false if pos is cleared");
        this.th.check(!bs.get(0), "returns false if pos is cleared/or not set -- 1");
        this.th.check(!bs.get(63), "returns false if pos is cleared/or not set -- 2");
    }
    ...
    public void test_or() {
        ...
        bs1.or(bs2);
        this.th.check(bs1.equals(bs2), "all ones ored with zeros give ones");
        for (i = 64; i < 128; ++i) {
            bs2.set(i);
        }
        ...
        bs3.or(bs2);
        this.th.check(!bs1.equals(bs3), "extra bits from bs2 are used -- got: " + bs3);
        this.th.check(bs2.equals(bs3), "lots of ones ored with nothing gives ones");
        bs4.or(bs1);
        this.th.check(bs4.equals(bs1), "extra bits in bs4 are left");
        bs1.clear(0);
        bs2.clear(0);
        bs2.or(bs1);
        this.th.check(!bs2.get(0), "checking or -- 1");
    ...
    public void test_xor() {
        ...
        BitSet bs3 = new BitSet(3);
        bs3.xor(bs1);
        this.th.check(!bs2.equals(bs3), "extra bits from bs1 are used -- got: " + bs3);
        this.th.check(bs3.equals(bs1), "lots of ones xored with nothing gives ones");
        bs1.xor(bs2);
        boolean ok = true;
        for (i = 0; i < 64; ++i) {
        ...
        bs2.clear(0);
        bs2.xor(bs1);
        this.th.check(!bs2.get(0), "checking xor -- 1");
        bs1.set(0);
        bs2.xor(bs1);
        this.th.check(bs2.get(0), "checking xor -- 2");
        bs2.xor(bs1);
        this.th.check(!bs2.get(0), "checking xor -- 3");
        bs2.xor(bs1);
    ...
    public void test_length() {
        this.th.checkPoint("length()void");
