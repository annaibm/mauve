...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedDeclaredConstructors_jdk6.put("public java.util.IllegalFormatCodePointException(int)", "java.util.IllegalFormatCodePointException");
        testedDeclaredConstructors_jdk7.put("public java.util.IllegalFormatCodePointException(int)", "java.util.IllegalFormatCodePointException");
