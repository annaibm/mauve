...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedDeclaredConstructors_jdk6.put("public java.util.IllegalFormatWidthException(int)", "java.util.IllegalFormatWidthException");
        testedDeclaredConstructors_jdk7.put("public java.util.IllegalFormatWidthException(int)", "java.util.IllegalFormatWidthException");
