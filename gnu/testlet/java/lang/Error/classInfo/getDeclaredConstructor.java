...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        constructorsThatShouldExist_jdk6.put("java.lang.Error", new Class[0]);
        constructorsThatShouldExist_jdk6.put("java.lang.Error", new Class[]{String.class});
        constructorsThatShouldExist_jdk6.put("java.lang.Error", new Class[]{String.class, Throwable.class});
        constructorsThatShouldExist_jdk6.put("java.lang.Error", new Class[]{Throwable.class});
        HashMap<String, Class[]> constructorsThatShouldExist_jdk7 = new HashMap<String, Class[]>();
        constructorsThatShouldExist_jdk7.put("java.lang.Error", new Class[]{String.class, Throwable.class, Boolean.TYPE, Boolean.TYPE});
        constructorsThatShouldExist_jdk7.put("java.lang.Error", new Class[]{Throwable.class});
        constructorsThatShouldExist_jdk7.put("java.lang.Error", new Class[]{String.class, Throwable.class});
        constructorsThatShouldExist_jdk7.put("java.lang.Error", new Class[]{String.class});
        constructorsThatShouldExist_jdk7.put("java.lang.Error", new Class[0]);
