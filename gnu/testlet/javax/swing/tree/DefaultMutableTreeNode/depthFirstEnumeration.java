...
public class depthFirstEnumeration
implements Testlet {
    @Override
    public void test(TestHarness h) {
        Enumeration<TreeNode> e = DefaultMutableTreeNodeTest.G.depthFirstEnumeration();
        ...
        e = DefaultMutableTreeNodeTest.A.depthFirstEnumeration();
