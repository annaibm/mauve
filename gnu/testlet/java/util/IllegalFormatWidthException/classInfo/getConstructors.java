...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedConstructors_jdk6.put("public java.util.IllegalFormatWidthException(int)", "java.util.IllegalFormatWidthException");
        testedConstructors_jdk7.put("public java.util.IllegalFormatWidthException(int)", "java.util.IllegalFormatWidthException");
