...
extends Panel
implements Testlet {
    private static final long serialVersionUID = -2613637171673465097L;
    ...
    public void test(TestHarness harness) {
        ...
        harness.checkPoint("space check #1 - negative test");
        harness.check(!this.getColorBetweenComponents(robot, frame, canvas1, canvas2).equals(Color.red));
        harness.checkPoint("space check #2 - negative test");
        harness.check(!this.getColorBetweenComponents(robot, frame, canvas1, canvas3).equals(Color.red));
        harness.checkPoint("space check #3 - negative test");
        harness.check(!this.getColorBetweenComponents(robot, frame, canvas1, canvas4).equals(Color.red));
        harness.checkPoint("space check #4 - negative test");
        harness.check(!this.getColorBetweenComponents(robot, frame, canvas2, canvas3).equals(Color.red));
        harness.checkPoint("space check #5 - negative test");
        harness.check(!this.getColorBetweenComponents(robot, frame, canvas3, canvas4).equals(Color.red));
        harness.checkPoint("space check #6 - negative test");
        harness.check(!this.getColorBetweenComponents(robot, frame, canvas2, canvas5).equals(Color.red));
        harness.checkPoint("space check #7 - negative test");
        harness.check(!this.getColorBetweenComponents(robot, frame, canvas3, canvas5).equals(Color.red));
        harness.checkPoint("space check #8 - negative test");
        harness.check(!this.getColorBetweenComponents(robot, frame, canvas4, canvas5).equals(Color.red));
        robot.waitForIdle();
        robot.delay(DELAY_AMOUNT);
        frame.dispose();
    }
