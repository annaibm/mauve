...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        String[] fieldsThatShouldExist_jdk6 = new String[]{"TRUE", "FALSE", "TYPE", "value", "serialVersionUID"};
        String[] fieldsThatShouldExist_jdk7 = new String[]{"TRUE", "FALSE", "TYPE", "value", "serialVersionUID"};
