...
implements Testlet {
    ...
    void testWithoutChildren(TestHarness h) {
        ...
        h.check(l.getLayoutAlignmentX(c), 0.0);
    }
    ...
    void testWithOneChild(TestHarness h) {
        ...
        c.add(c1);
        OverlayLayout l = new OverlayLayout(c);
        h.check(l.getLayoutAlignmentX(c), 0.5);
    }
    ...
    void testWithAlignment(TestHarness h) {
        ...
        c.add(c3);
        OverlayLayout l = new OverlayLayout(c);
        h.check(l.getLayoutAlignmentX(c), 0.6666666865348816);
    }
    ...
    void testWrongContainer(TestHarness h) {
        ...
        try {
            h.check(l.getLayoutAlignmentX(c2), 0.5);
