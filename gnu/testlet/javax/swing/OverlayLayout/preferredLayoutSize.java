...
implements Testlet {
    ...
    void testWithoutChildren(TestHarness h) {
        ...
        h.check(l.preferredLayoutSize((Container)c).width, 0);
        h.check(l.preferredLayoutSize((Container)c).height, 0);
    }

    void testWithOneChild(TestHarness h) {
        h.checkPoint("withOneChildren");
        JPanel c = new JPanel();
        ...
        c.add(c1);
        OverlayLayout l = new OverlayLayout(c);
        h.check(l.preferredLayoutSize((Container)c).width, 20);
        h.check(l.preferredLayoutSize((Container)c).height, 20);
    }
    ...
    void testWithTwoChildren(TestHarness h) {
        ...
        c.add(c2);
        OverlayLayout l = new OverlayLayout(c);
        h.check(l.preferredLayoutSize((Container)c).width, 50);
        h.check(l.preferredLayoutSize((Container)c).height, 50);
    }
    ...
    void testWithAlignment(TestHarness h) {
        ...
        c.add(c3);
        OverlayLayout l = new OverlayLayout(c);
        h.check(l.preferredLayoutSize((Container)c).width, 75);
        h.check(l.preferredLayoutSize((Container)c).height, 50);
    }
    ...
    void testWrongContainer(TestHarness h) {
        ...
        try {
            h.check(l.preferredLayoutSize((Container)c2).width, 30);
