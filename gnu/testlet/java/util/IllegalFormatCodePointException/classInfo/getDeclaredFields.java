...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedDeclaredFields_jdk6.put("private static final long java.util.IllegalFormatCodePointException.serialVersionUID", "serialVersionUID");
        testedDeclaredFields_jdk6.put("private int java.util.IllegalFormatCodePointException.c", "c");
        testedDeclaredFields_jdk7.put("private static final long java.util.IllegalFormatCodePointException.serialVersionUID", "serialVersionUID");
        testedDeclaredFields_jdk7.put("private int java.util.IllegalFormatCodePointException.c", "c");
