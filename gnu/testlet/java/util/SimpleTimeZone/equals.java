...
implements Testlet {
    ...
    private void test1(TestHarness harness) {
        ...
        harness.check(z2.equals(z1));
        int rawOffset1 = 18000000;
        int rawOffset2 = 21600000;
        int time1 = 0x6DDD00;
        int time2 = 10800000;
        z1 = new SimpleTimeZone(rawOffset1, "Z1", 3, 5, 0, time1, 8, 15, 0, time2, 3600000);
        z2 = new SimpleTimeZone(rawOffset1, "Z1", 3, 5, 0, time1, 8, 15, 0, time2, 3600000);
        harness.check(z1.equals(z2));
        z1 = new SimpleTimeZone(rawOffset2, "Z1", 3, 5, 0, time1, 8, 15, 0, time2, 3600000);
        harness.check(!z1.equals(z2));
        z2 = new SimpleTimeZone(rawOffset2, "Z1", 3, 5, 0, time1, 8, 15, 0, time2, 3600000);
        harness.check(z1.equals(z2));
        z1 = new SimpleTimeZone(rawOffset2, "Z2", 3, 5, 0, time1, 8, 15, 0, time2, 3600000);
        harness.check(!z1.equals(z2));
        z2 = new SimpleTimeZone(rawOffset2, "Z2", 3, 5, 0, time1, 8, 15, 0, time2, 3600000);
        harness.check(z1.equals(z2));
        z1 = new SimpleTimeZone(rawOffset2, "Z2", 4, 5, 0, time1, 8, 15, 0, time2, 3600000);
        harness.check(!z1.equals(z2));
        z2 = new SimpleTimeZone(rawOffset2, "Z2", 4, 5, 0, time1, 8, 15, 0, time2, 3600000);
        harness.check(z1.equals(z2));
        z1 = new SimpleTimeZone(rawOffset2, "Z2", 4, 6, 0, time1, 8, 15, 0, time2, 3600000);
        harness.check(!z1.equals(z2));
        z2 = new SimpleTimeZone(rawOffset2, "Z2", 4, 6, 0, time1, 8, 15, 0, time2, 3600000);
        harness.check(z1.equals(z2));
        z1 = new SimpleTimeZone(rawOffset2, "Z2", 4, 6, 0, time2, 8, 15, 0, time2, 3600000);
        harness.check(!z1.equals(z2));
        z2 = new SimpleTimeZone(rawOffset2, "Z2", 4, 6, 0, time2, 8, 15, 0, time2, 3600000);
        harness.check(z1.equals(z2));
        z1 = new SimpleTimeZone(rawOffset2, "Z2", 4, 6, 0, time2, 9, 15, 0, time2, 3600000);
        harness.check(!z1.equals(z2));
        z2 = new SimpleTimeZone(rawOffset2, "Z2", 4, 6, 0, time2, 9, 15, 0, time2, 3600000);
        harness.check(z1.equals(z2));
        z1 = new SimpleTimeZone(rawOffset2, "Z2", 4, 6, 0, time2, 9, 16, 0, time2, 3600000);
        harness.check(!z1.equals(z2));
        z2 = new SimpleTimeZone(rawOffset2, "Z2", 4, 6, 0, time2, 9, 16, 0, time2, 3600000);
        harness.check(z1.equals(z2));
        z1 = new SimpleTimeZone(rawOffset2, "Z2", 4, 6, 0, time2, 9, 16, 0, time1, 3600000);
        harness.check(!z1.equals(z2));
        z2 = new SimpleTimeZone(rawOffset2, "Z2", 4, 6, 0, time2, 9, 16, 0, time1, 3600000);
        harness.check(z1.equals(z2));
        z1 = new SimpleTimeZone(rawOffset2, "Z2", 4, 6, 0, time2, 9, 16, 0, time1, 3600001);
        harness.check(!z1.equals(z2));
    ...
    private void test2(TestHarness harness) {
        ...
        harness.check(!((Object)tz2).equals(tz3));
