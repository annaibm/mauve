...
implements Testlet {
    ...
    public void test(TestHarness harness) {
        ...
        testedDeclaredMethods_jdk6.put("public java.lang.String java.util.IllegalFormatFlagsException.getMessage()", "getMessage");
        testedDeclaredMethods_jdk6.put("public java.lang.String java.util.IllegalFormatFlagsException.getFlags()", "getFlags");
        testedDeclaredMethods_jdk7.put("public java.lang.String java.util.IllegalFormatFlagsException.getMessage()", "getMessage");
        testedDeclaredMethods_jdk7.put("public java.lang.String java.util.IllegalFormatFlagsException.getFlags()", "getFlags");
