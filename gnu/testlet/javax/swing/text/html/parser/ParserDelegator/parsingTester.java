...
implements Testlet {
    ...
    public void testHTMLParsing() {
        this.verify("<b><i><u>text</b><i></u>", "<html _implied_='true'><head _implied_='true'></head><body _implied_='true'><b><i><u>'text'</u></i></b><i></i></body></html>", "subseqent tags");
        ...
        this.verify("<hr id='id_&#41;&#90' class= \"&#89;_&amp;\" >", "<html _implied_='true'><head _implied_='true'></head><body _implied_='true'><hr class='y_&' id='id_)Z'/></body></html>", "Numeric and named entities in attributes");
        ...
        this.verify("<option id=a selected><option id=b selected = selected class=cC><input checked>", "<html _implied_='true'><head _implied_='true'></head><body _implied_='true'><option id='a' selected='selected'></option><option class='cc' id='b' selected='selected'></option><input checked='checked'/></body></html>", "Attributes without value");
